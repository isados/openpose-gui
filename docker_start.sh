...
./build/examples/openpose/openpose.bin --camera 0 --disable_blending --write_keypoint_json /data/new_model/keypoints_json --output_resolution 640x352 --write_images /data/new_model/cached_images/ > ./docker_start.pid
